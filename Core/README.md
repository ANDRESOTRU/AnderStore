...
Встроенная часть приложения **AnderStore** (проект ANDRESOT). Форк [LiveContainer/SideStore](https://github.com/LiveContainer/SideStore), который основан на [SideStore](https://github.com/SideStore/SideStore) и AltStore.

- Anisette по умолчанию: `https://anisette.andresot.uk`
- Магазин: `https://store.andresot.uk/source.json`

Лицензия: AGPL-3.0, авторские права оригинальных авторов сохранены.
