...
private extension RefreshAttemptsViewController
{
    func makeDataSource() -> FetchedResultsTableViewDataSource<RefreshAttempt>
    {
        ...
        placeholderView.detailTextLabel.text = NSLocalizedString("The more you use AnderStore, the more often iOS will allow it to refresh apps in the background.", comment: "")
