    ...
    var body: some View {
        ZStack {
            if viewModel.isLoading && viewModel.internalApps.isEmpty && viewModel.resignedApps.isEmpty {
                ...
                List {
                    Section(header: Text("Internal App Cache"), footer: Text("Cached unzipped app bundles stored in AnderStore's private container. These are used during automatic background refreshes and resigns.")) {
        ...
        .alert(isPresented: $viewModel.showDeleteAlert) {
            ...
            return Alert(
                ...
                message: Text("If deleted, AnderStore will require the original IPA file during reinstall, backup, resign, or refresh procedures. Are you sure you want to delete the cached app bundle for “\(appName)” ?"),
