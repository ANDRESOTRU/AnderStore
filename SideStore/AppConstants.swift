...
public enum AppConstants {
    ...
    public enum Sources {
        ...
        public static let defaultSourcesURL           = URL(string: "https://store.andresot.uk/default-sources.json")!
        public static let sideStoreCommunitySourceURL = URL(string: "https://store.andresot.uk/source.json")!
        public static let sideStoreFallbackIconURL    = URL(string: "https://store.andresot.uk/icons/store.png")!
    ...
    public enum Anisette {
        ...
        public enum Servers {
            public static let defaultSource        = "https://store.andresot.uk/anisette-servers.json"
            public static let defaultServerURL     = "https://anisette.andresot.uk"
